...
class theme_h5pmod_mod_hvp_renderer extends mod_hvp_renderer {
    ...
    public function hvp_alter_styles(&$styles, $libraries, $embedType) {
        ...
        if (
            ...
            $styles[] = (object) array(
                'path'    => $CFG->httpswwwroot . '/theme/iomadboost/style/h5p_custom.css',
                'version' => '?ver=0.0.1',
            );
        }
    }
    ...
    public function hvp_alter_scripts(&$scripts, $libraries, $embedType) {
        ...
        if (
            ...
            $include_file = ($embedType === 'editor' ? 'h5p_customEditor.js' : 'h5p_custom.js');
            $scripts[] = (object) array(
                'path'    => $CFG->httpswwwroot . '/theme/iomadboost/js/' . $include_file,
                'version' => '?ver=0.0.1',
            );
        }
    }
